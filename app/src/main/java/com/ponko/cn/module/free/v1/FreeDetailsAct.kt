...
import com.ponko.cn.module.free.v1.adapter.FreeDetailFragmentPagerAdapter
import com.ponko.cn.module.free.v1.constract.FreeDetailsConstract
...
class FreeDetailsAct : PonkoBaseAct<FreeDetailsConstract.Present>(), FreeDetailsConstract.V {
    ...
    override fun displayVideo(detailCBean: DetailCBean?) {
        ...
        val pos = detailCBean.chapters!![0].sections[0]?.progressDuration!!*1000
