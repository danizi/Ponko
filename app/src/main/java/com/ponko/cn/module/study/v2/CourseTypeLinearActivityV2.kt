 ...
 * 专题下的课程列表
 */
class CourseTypeLinearActivityV2 : RefreshLoadAct<Any, CourseAllCBean>() {
    companion object {
        fun start(context: Context?, title: String?, typeId: String?) {
            val intent = Intent(context, CourseTypeLinearActivityV2::class.java)
    ...
    override fun requestRefreshApi() {
        PonkoApp.studyApi?.getSpecialAllCourseV2(typeId!!)?.enqueue(object : HttpCallBack<CourseAllCBean>() {
