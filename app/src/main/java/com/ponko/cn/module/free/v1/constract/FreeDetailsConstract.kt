        ...
        fun requestFreeDetailApi() {
            m.requestFreeDetailApi(m.id, object : HttpCallBack<DetailCBean>() {
                override fun onSuccess(call: Call<DetailCBean>?, response: Response<DetailCBean>?) {
                    ...
                    V.WebFragment.detailContentBean = DetailContentBean(detailCBean?.summary_url, detailCBean?.chapters)
                    V.ChaptersFragment.detailContentBean = DetailContentBean(detailCBean?.summary_url, detailCBean?.chapters)
                    frgs.add(V.WebFragment())
                    frgs.add(V.ChaptersFragment())
                    m.frgs = frgs
