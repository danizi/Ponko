...
class SectionCBean() : Parcelable, Serializable {
...
//    var filePath = ""
    ...
    companion object CREATOR : Parcelable.Creator<SectionCBean> {
        override fun createFromParcel(parcel: Parcel): SectionCBean = SectionCBean(parcel)

        override fun newArray(size: Int): Array<SectionCBean?> = arrayOfNulls(size)
    }
